...
|
*/
$config['encryption_key'] = 'maulana-reza';
...
$config['proxy_ips'] = '';
// IMAGE PATH
$config['img_path'] = $config['base_url'].getenv('IMG_PATH');
$config['whatsapp_number']	= "whatsapp://send?phone=";
$config['whatsapp_mess'] 	= "&text=Hi, I contacted you Through your website.";
// map direction lat long
$config['map_direction']	= "https://www.google.com/maps?saddr=45.34802,-75.91903&daddr=45.424807,-75.699234";
...
$config['upgrade_confirm']  = "Akun anda telah terupgrade, sekarang anda bisa menambahkan mobil";
// confirm (administrator)
