...
$config['admin_email']                = getenv('EMAIL_USER'); // Admin Email, admin@example.com
...
IMPORTANT: If you are changing it from the default (email),
															    		   udate the UNIQUE constraint in your DB */
$config['min_password_length']        = 8;                   // Minimum Required Length of Password (not enforced by lib - see note above)
$config['email_activation']           = getenv('EMAIL_ACTIVATION');               // Email Activation for registration
...
$config['email_config'] = Array(
	...
	'smtp_user' => getenv('EMAIL_USER'), // actual values different
